...
const Projects = () => {
  return (
    <div name='projects' className='pb-2 space-y-10 w-full md:h-screen text-gray-300 bg-[#0D1116]'>
        ...
        <div className='mb-8 pt-8 space-y-10 text-center sm:grid-cols-2 md:grid-cols-3 gap-4'src={portfolio}>
